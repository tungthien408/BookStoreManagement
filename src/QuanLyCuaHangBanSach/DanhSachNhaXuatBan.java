...
public class DanhSachNhaXuatBan implements Serializable, DanhSach {
    private ArrayList<NhaXuatBan> listNhaXuatBan = new ArrayList<>();
    private int count = 0;

    public DanhSachNhaXuatBan() {
        listNhaXuatBan.add(new NhaXuatBan("Kim Dong", "TPHCM", "9045495", "kimdong@email", getID()));
        listNhaXuatBan.add(new NhaXuatBan("Tre", "Ha Noi", "549844", "nxbtre@email", getID()));
        listNhaXuatBan.add(new NhaXuatBan("Giao Duc", "Ha Noi", "123456", "nxbgd@email", getID()));
        listNhaXuatBan.add(new NhaXuatBan("Tong Hop", "TPHCM", "987654", "tonghop@email", getID()));
    }
    ...
    public void themNXB() {
        ...
        listNhaXuatBan.add(new NhaXuatBan(tenNXB, diaChi, sdt, email, maNXB));
    }

    public void suaNXB() {
        String id = Check.takeStringInput("Ma nha xuat ban can sua: ");
        NhaXuatBan nhaXuatBan = timKiemTheoID(id);
        if(nhaXuatBan != null) {
            boolean out = false;
            do {
                xuatTieuDe();
    ...
    public NhaXuatBan timKiemTheoID(String id) {
        for(NhaXuatBan nhaXuatBan : listNhaXuatBan)
    ...
    public void xoaNXB() {
        ...
        NhaXuatBan find = timKiemTheoID(id);
    ...
    public void timKiem() {
        ...
        ArrayList<NhaXuatBan> listFilter = new ArrayList<>();
        for(NhaXuatBan nhaXuatBan : listNhaXuatBan) {
            if(
