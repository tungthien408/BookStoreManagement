...
public class DanhSachSach implements Serializable, DanhSach {
    ...
    public void themSach(DanhSachTacGia danhSachTacGia, DanhSachNhaXuatBan dsNXB) {
    ...
    public String nhapMaTacGia(DanhSachTacGia danhSachTacGia) {
        String maTG;
        boolean check;
        do {
            check = false;
    ...
    public String nhapMaNXB(DanhSachNhaXuatBan dsNXB) {
        String maNXB;
        boolean check;
        do {
            check = false;
