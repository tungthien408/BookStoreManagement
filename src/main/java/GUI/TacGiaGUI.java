...
public class TacGiaGUI {
    ...
    private void exportToExcel() {
        ...
        fileChooser.setSelectedFile(new File("Danh_sach_Tac_Gia.xlsx"));
    ...
    private void deleteTacGia() {
        ...
        // }
            ...
            try {
                ...
                if (JOptionPane.showConfirmDialog(null, "Bạn có chắc muốn xóa tác giả này?", "Xóa thông tin tác giả",
    ...
    private boolean checkValidate(TacGiaDTO tacGia) {
        ...
        if (tacGia.getMaTG().isEmpty() || tacGia.getTenTG().isEmpty() || tacGia.getDiaChi().isEmpty()
                || tacGia.getSdt().isEmpty()) {
