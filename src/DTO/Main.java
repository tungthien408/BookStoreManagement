                    ...
                    if (nguoi == null)
                        ...
                        if (nguoi instanceof QuanLyDTO) {
                            ...
                            do {
                                ...
                                System.out.println("7. Xem danh sach hoa don");
                                System.out.println("0. Dang xuat");
                                switch (Check.takeInputChoice(0, 7)) {
                                    ...
                                    case 6 -> dsPhieuNhap.menu(danhSachSach, nguoi, bookShop, danhSachNhaXuatBan);
                                    case 7 -> danhSachHoaDon.menuHD(danhSachSach, nguoi, bookShop);
